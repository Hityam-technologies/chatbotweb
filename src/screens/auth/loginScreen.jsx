  ...
  return (
    <div className="login-screen fixed inset-0 w-full h-full z-[9999] bg-white overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none z-[5]">
        ...
        <div className="absolute inset-0 bg-gradient-to-bl from-[#0a0a0a]/80 via-transparent to-transparent" />
      </div>
      ...
      <div className="absolute inset-0 z-10 pointer-events-none">
        ...
        {/* Auth Form Container */}
        <div
          className={`absolute right-8 md:right-16 top-1/2 -translate-y-1/2 pointer-events-auto transition-all duration-1000 ease-[cubic-bezier(0.2,0.8,0.2,1)] ${showForm ? 'opacity-100 scale-100 translate-x-0' : 'opacity-0 scale-110 translate-x-12 pointer-events-none'
            }`}
        >
